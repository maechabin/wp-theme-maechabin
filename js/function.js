...
},{"cbsharecount":2,"cbslideheader":3,"slideshowad":5}],2:[function(require,module,exports){
(function (global){
'use strict';
...
;(function (factory) {
  if ((typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object' && _typeof(module.exports) === 'object') {
    module.exports = factory(typeof window !== "undefined" ? window['$'] : typeof global !== "undefined" ? global['$'] : null, window);
  } else {
...
!function (e) {
  "use strict";
  "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && "object" == _typeof(module.exports) ? module.exports = e(typeof window !== "undefined" ? window['$'] : typeof global !== "undefined" ? global['$'] : null, window, document) : e(jQuery, window, document);
}(function (e, i, o, t) {
  "use strict";
  var n = function n(i, o) {
    this.element = i, this.$element = e(i), this.methodType = "", this.config = {}, this.options = o, this.slideFlag = "up", this.defaults = { headerBarHeight: this.$element.height(), headerBarWidth: "100%", header2SelectorName: ".cb-header2", headerClone: !1, fullscreenView: !1, zIndex: 9999, boxShadow: "none", opacity: 1, slidePoint: 0, slideDownDuration: "normal", slideUpDuration: "normal", slideDownEasing: "swing", slideUpEasing: "swing", slideDownCallback: function slideDownCallback() {}, slideUpCallback: function slideUpCallback() {}, headroom: !1 };
  };n.prototype.slide = function (e, o, t, n) {
    var s = this;this.slideFlag = "up" === e ? "down" : "up", i.setTimeout(function () {
      s.$element.stop().animate({ top: o }, s.config["slide" + t + "Speed"], s.config["slide" + t + "Easing"], s.config["slide" + t + "Callback"]).css(n);
    }, 200);
    ...
    var o = this,
        ...
        a = { "box-shadow": o.config.boxShadow, transition: "box-shadow .9s linear" },
        h = { "box-shadow": "none" },
        c = "slideDown" === o.methodType ? a : h,
        r = "slideDown" === o.methodType ? h : a,
        p = 0,
        g = 0;t.on("scroll", function () {
      "slideUp" === o.methodType && o.config.headroom === !0 ? (g = t.scrollTop(), g > p && g > o.config.slidePoint ? "up" === o.slideFlag && o.slide.call(o, o.slideFlag, n, d, c) : "down" === o.slideFlag && o.slide.call(o, o.slideFlag, s, l, r), p = g) : t.scrollTop() > o.config.slidePoint ? "up" === o.slideFlag && o.slide.call(o, o.slideFlag, n, d, c) : "down" === o.slideFlag && o.slide.call(o, o.slideFlag, s, l, r);
    });
  }, n.prototype.setStyle = function () {
    var e = this,
        i = "slideDown" === e.methodType ? "-" + e.config.headerBarHeight + "px" : 0;e.$element.css({ top: i, visibility: "visible", opacity: e.config.opacity, width: e.config.width, "z-index": e.config.zIndex });
  }, n.prototype.cloneHeader = function () {
    var e = this,
        i = e.$element.clone(!0);i.insertAfter(e.$element).removeClass("cb-header").addClass("cb-header1").css({ "z-index": 1e4 });
    ...
    var o = this,
        ...
        s = t + n.height(),
        d = e(i).height(),
        l = "";d > s ? (l = o.config.headerClone === !0 ? (d - s) / 2 : (d - s + t) / 2, o.config.slidePoint = d, n.css({ "padding-top": l + "px", "padding-bottom": l + "px" })) : o.config.headerClone === !0 ? o.config.slidePoint = s : o.config.slidePoint = s - t;
  ...
  }, e.extend(e.fn, { cbSlideDownHeader: function cbSlideDownHeader(e) {
      return this.each(function () {
        new n(this, e).init("slideDown");
      });
    }, cbSlideUpHeader: function cbSlideUpHeader(e) {
      return this.each(function () {
...
},{"SlideShowAd":6}],6:[function(require,module,exports){
'use strict';
